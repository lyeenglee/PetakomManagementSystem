...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{_('Lecturer View Activity Details') }}</div>
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="col">
                            <div class="text-end">
                                <a href="{{ url('/lecturer/activity/menu/') }}" class="col-2 btn btn-secondary pull-right" title="Add New Student">Back</a>
                            </div>
                        </div> 
