                ...
                <div class="card-body">
                    <form action="{{ url('activity/' .$activities->activityID) }}" method="POST" onchange="myFunction()" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col=md-6">
                                <input id="activityName" type="text" class="form-control" name="activityName" value="{{$activities->activityName}}" required/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col=md-6">
                                <input id="activityVenue" type="text" class="form-control"name="activityVenue" value="{{$activities->activityVenue}}" required/>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col=md-6">
                                <textarea id="activityDescription" type="text" class="form-control" name="activityDescription" rows="5" required>{{$activities->activityDescription}}</textarea>
                            </div>
                        </div>
