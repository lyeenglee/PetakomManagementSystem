...
@section('title', 'Student View Committee')
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h3 style="text-align:center;font-weight: bold;">View Committee</h3><br/>
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="col">
                        <div class="text-center">
                            <a href="{{ url('/student/election/studentViewCommitteeMenu') }}" class="col-2 btn btn-secondary pull-right">Back</a>
                        </div>
                    </div>    
                </div>
            </div>
