...
@section('title', 'Student View Candidate Menu')
<div class="container">
    <div class="row justify-content-center">
        
        <div class="col-md-8"> 
        <h3 style="text-align:center;font-weight: bold;">Candidate List</h3><br>
            <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered" id="electionTable">
                            ...
                            @foreach($candidateList as $item)
                                ...
                                <td>{{ $item->category}}</td>
                                <td >   
                                    <a href="{{ url('/student/election/viewCandidate/' . $item->electionID) }}" title="View election"><button class="btn btn-primary "><i class="fa fa-eye" aria-hidden="true"></i> View</button></a>
                                </td>
                            </tr>
                            @endforeach
                            </tbody>
